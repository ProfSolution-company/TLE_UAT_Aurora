...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	ПараметрыРегистрации.Информация = "Внешняя печатная форма МХ-1 для документа ""Акт приемки"". Задача № 2541 Профрешение";
...
Функция ПечатьМХ1(МассивОбъектов)
	...
	Для Каждого мОбъект из МассивОбъектов Цикл 
		...
		ПечатьШапки(ТабДокумент, Макет, мОбъект.Ссылка);
		
		ПечатьСтрок(ТабДокумент, Макет, мОбъект.Ссылка);
